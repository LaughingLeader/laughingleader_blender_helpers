...
bl_info = {
    "name": "Layer Manager",
    "author": "Alfonso Annarumma, Bastien Montagne, modified/updated by LaughingLeader",
    "version": (1, 5, 4),
    "blender": (2, 7, 9),
    "location": "Toolshelf > Layers Tab",
    "warning": "",
    "description": "Display and Edit Layer Names",
    "wiki_url": "",
    "wiki_url_old": "https://wiki.blender.org/index.php/Extensions:2.6/Py/"
...
class SCENE_PT_namedlayer_layers(Panel):
    ...
    def draw(self, context):
        ...
        namedlayers = getattr(scene, "namedlayers", None)
...
def register_manual():
    ...
    # print("=======================================")
    # print("CollectionProperty trace")
